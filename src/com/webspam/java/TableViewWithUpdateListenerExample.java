...
public class TableViewWithUpdateListenerExample extends Application {
	...
	public void start(Stage primaryStage) {
		...
		ObservableList<Person> data = FXCollections.observableArrayList(person -> new Observable[] {
				person.firstNameProperty(), person.lastNameProperty(), person.emailProperty() });
